...
const siteConfig = {
  ...
  headerLinks: [
    { doc: 'containerization/container-overview', label: 'Container Training'},
    { doc: 'kubernetes/kubernetes-overview', label: 'Kubernetes Training'}
  ],
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} anynines GmbH`,
